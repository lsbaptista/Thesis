...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow  =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
  \KeywordTok{chartSeries}\NormalTok{(TEF.MC,}\DataTypeTok{theme =} \KeywordTok{chartTheme}\NormalTok{(}\StringTok{"white"}\NormalTok{))}
  \KeywordTok{chartSeries}\NormalTok{(ENEL.MI,}\DataTypeTok{theme =} \KeywordTok{chartTheme}\NormalTok{(}\StringTok{"white"}\NormalTok{))}
  \KeywordTok{chartSeries}\NormalTok{(GLE.PA,}\DataTypeTok{theme =} \KeywordTok{chartTheme}\NormalTok{(}\StringTok{"white"}\NormalTok{))}
  \KeywordTok{chartSeries}\NormalTok{(AIR.PA,}\DataTypeTok{theme =} \KeywordTok{chartTheme}\NormalTok{(}\StringTok{"white"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{returns \textless{}{-}}\StringTok{ }\KeywordTok{as.xts}\NormalTok{(}\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{dailyReturn}\NormalTok{(newdata}\OperatorTok{$}\NormalTok{TEF.MC,}\DataTypeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{),}\KeywordTok{round}\NormalTok{(}\KeywordTok{dailyReturn}\NormalTok{(newdata}\OperatorTok{$}\NormalTok{ENEL.MI,}\DataTypeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{),}\KeywordTok{round}\NormalTok{(}\KeywordTok{dailyReturn}\NormalTok{(newdata}\OperatorTok{$}\NormalTok{GLE.PA,}\DataTypeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{),}\KeywordTok{round}\NormalTok{(}\KeywordTok{dailyReturn}\NormalTok{(newdata}\OperatorTok{$}\NormalTok{AIR.PA,}\DataTypeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{)))}
...
\caption{\label{tab:unnamed-chunk-24}TEF coeficientes}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-25}Information Criterion Statistics}
\centering
\begin{tabular}[t]{lr}
\toprule
  & x\\
...
\caption{\label{tab:unnamed-chunk-26}Standardized Residuals Tests}
\centering
...
\caption{\label{tab:unnamed-chunk-28}ENEL coeficientes}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
  &  Estimate &  Std. Error &  t value & Pr(>|t|)\\
...
\caption{\label{tab:unnamed-chunk-29}ENEL Information Criterion Statistics}
\centering
\begin{tabular}[t]{lr}
\toprule
  & x\\
...
\caption{\label{tab:unnamed-chunk-30}ENEL Standardized Residuals Tests}
\centering
\begin{tabular}[t]{lrrr}
\toprule
  & lags & statistic & p-value\\
...
\caption{\label{tab:unnamed-chunk-32}GLE coeficientes}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
  &  Estimate &  Std. Error &  t value & Pr(>|t|)\\
...
\caption{\label{tab:unnamed-chunk-33}GLE Information Criterion Statistics}
\centering
\begin{tabular}[t]{lr}
\toprule
  & x\\
...
\caption{\label{tab:unnamed-chunk-34}GLE Standardized Residuals Tests}
\centering
\begin{tabular}[t]{lrrr}
\toprule
  & lags & statistic & p-value\\
...
\caption{\label{tab:unnamed-chunk-36}AIR coeficientes}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
  &  Estimate &  Std. Error &  t value & Pr(>|t|)\\
...
\caption{\label{tab:unnamed-chunk-37}AIR Information Criterion Statistics}
\centering
\begin{tabular}[t]{lr}
\toprule
  & x\\
...
\caption{\label{tab:unnamed-chunk-38}AIR Standardized Residuals Tests}
\centering
\begin{tabular}[t]{lrrr}
\toprule
  & lags & statistic & p-value\\
...
\caption{\label{tab:unnamed-chunk-40}Volatilidade Implícita}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrr}
\toprule
