...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{returns }\OtherTok{\textless{}{-}} \FunctionTok{as.xts}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\FunctionTok{round}\NormalTok{(}\FunctionTok{dailyReturn}\NormalTok{(newdata}\SpecialCharTok{$}\NormalTok{TEF.MC,}\AttributeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{),}
                             \FunctionTok{round}\NormalTok{(}\FunctionTok{dailyReturn}\NormalTok{(newdata}\SpecialCharTok{$}\NormalTok{ENEL.MI,}\AttributeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{),}
                             \FunctionTok{round}\NormalTok{(}\FunctionTok{dailyReturn}\NormalTok{(newdata}\SpecialCharTok{$}\NormalTok{GLE.PA,}\AttributeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{),}
                             \FunctionTok{round}\NormalTok{(}\FunctionTok{dailyReturn}\NormalTok{(newdata}\SpecialCharTok{$}\NormalTok{AIR.PA,}\AttributeTok{type=}\StringTok{"log"}\NormalTok{),}\DecValTok{4}\NormalTok{)))}
\NormalTok{returns }\OtherTok{\textless{}{-}}\NormalTok{ returns[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,]}
\FunctionTok{colnames}\NormalTok{(returns)}\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(}\StringTok{"Telefónica"}\NormalTok{,}\StringTok{"Enel"}\NormalTok{,}\StringTok{"Société Générale "}\NormalTok{,}\StringTok{"Airbus"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{ewma }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x) \{  }
\NormalTok{  x}\OtherTok{\textless{}{-}}\FunctionTok{ewmaVol}\NormalTok{(x,}\AttributeTok{lambda =} \FloatTok{0.94}\NormalTok{)}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{tail}\NormalTok{(x}\SpecialCharTok{$}\NormalTok{sigma,}\DecValTok{1}\NormalTok{))}
\NormalTok{\}}
\NormalTok{pewma }\OtherTok{\textless{}{-}} \FunctionTok{do.call}\NormalTok{(data.frame, }
                 \FunctionTok{list}\NormalTok{(}\StringTok{"ewma"}\OtherTok{=} \FunctionTok{round}\NormalTok{(}\FunctionTok{apply}\NormalTok{(returns,}\DecValTok{2}\NormalTok{,ewma),}\DecValTok{6}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/gewma-1} 
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{dfewma }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(pewma)}

\NormalTok{N }\OtherTok{\textless{}{-}} \DecValTok{80}
\NormalTok{dia }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{:}\NormalTok{N}
\NormalTok{M }\OtherTok{\textless{}{-}} \DecValTok{1000}
\NormalTok{mu }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FloatTok{0.00575}

\NormalTok{TEF.preco\_inicial }\OtherTok{\textless{}{-}}\NormalTok{ TEF.MC}\SpecialCharTok{$}\NormalTok{Close[[}\FunctionTok{nrow}\NormalTok{(TEF.MC}\SpecialCharTok{$}\NormalTok{Close)]]}
\NormalTok{TEF.MC.sigma }\OtherTok{\textless{}{-}}\NormalTok{ dfewma}\SpecialCharTok{$}\NormalTok{Telefónica}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{252}\NormalTok{)}
\NormalTok{TEF.MC.mean }\OtherTok{\textless{}{-}}\NormalTok{ (mu}\SpecialCharTok{{-}}\NormalTok{(TEF.MC.sigma}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\DecValTok{252}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{ewmaweights }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FloatTok{0.2502928}\NormalTok{, }\FloatTok{0.5540359}\NormalTok{, }\FloatTok{0.1141192}\NormalTok{, }\FloatTok{0.0815521}\NormalTok{)}
\NormalTok{ModVaR\_95\_ewma }\OtherTok{\textless{}{-}} \FunctionTok{VaR}\NormalTok{(myPortfolioReturns, }\AttributeTok{p=}\FloatTok{0.95}\NormalTok{,}\AttributeTok{weights=}\NormalTok{ewmaweights, }
                      \AttributeTok{portfolio\_method =} \StringTok{"component"}\NormalTok{, }\AttributeTok{method =} \StringTok{"modified"}\NormalTok{)}
\NormalTok{ModVaR\_95\_ewma}\SpecialCharTok{$}\NormalTok{contribution }
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{TEF}\OtherTok{\textless{}{-}}\FunctionTok{garchFit}\NormalTok{(}\AttributeTok{formula =} \SpecialCharTok{\textasciitilde{}} \FunctionTok{garch}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{),}\AttributeTok{data=}\NormalTok{returns}\SpecialCharTok{$}\NormalTok{Telefónica,}\AttributeTok{cond.dist =} \StringTok{"std"}\NormalTok{,  }\AttributeTok{include.mean=}\ConstantTok{FALSE}\NormalTok{, }
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{ENEL}\OtherTok{\textless{}{-}}\FunctionTok{garchFit}\NormalTok{(}\AttributeTok{formula =} \SpecialCharTok{\textasciitilde{}} \FunctionTok{garch}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{),}\AttributeTok{data=}\NormalTok{returns}\SpecialCharTok{$}\NormalTok{Enel,}\AttributeTok{cond.dist =} \StringTok{"std"}\NormalTok{, }\AttributeTok{include.mean=}\ConstantTok{FALSE}\NormalTok{, }
               \AttributeTok{trace=}\ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{GLE}\OtherTok{\textless{}{-}}\FunctionTok{garchFit}\NormalTok{(}\AttributeTok{formula =} \SpecialCharTok{\textasciitilde{}} \FunctionTok{arma}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{garch}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{),}\AttributeTok{data=}\NormalTok{returns}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Société Générale}\StringTok{\textasciigrave{}}\NormalTok{,}
              \AttributeTok{cond.dist =} \StringTok{"std"}\NormalTok{,}\AttributeTok{include.mean=}\ConstantTok{FALSE}\NormalTok{, }\AttributeTok{trace=}\ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\#R CODE}
\NormalTok{AIR.spec }\OtherTok{\textless{}{-}} \FunctionTok{ugarchspec}\NormalTok{(}\AttributeTok{variance.model=}\FunctionTok{list}\NormalTok{(}\AttributeTok{model=}\StringTok{"eGARCH"}\NormalTok{,}\AttributeTok{garchOrder=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{)),}
                           \AttributeTok{mean.model=}\FunctionTok{list}\NormalTok{(}\AttributeTok{armaOrder=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{)),}\AttributeTok{distribution.model=}\StringTok{"std"}\NormalTok{)}

\NormalTok{AIR }\OtherTok{\textless{}{-}} \FunctionTok{ugarchfit}\NormalTok{(AIR.spec, returns}\SpecialCharTok{$}\NormalTok{Airbus) }
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.7\linewidth]{bookdown-demo_files/figure-latex/frontgarch-1} 
...
{\centering \includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/retggplot-1} 
...
\addcontentsline{toc}{chapter}{Conclusão e perspectivas futuras}
