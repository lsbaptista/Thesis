...
\caption{Evolução da covariância a medida que se aumenta os activos no portfolio.}\label{fig:covusa}
\end{figure}
\FloatBarrier
\centering
...
{\centering \includegraphics[width=0.8\linewidth]{image/cotacao} 
...
\KeywordTok{getSymbols}\NormalTok{(symbolsEU,}\DataTypeTok{src =} \StringTok{"yahoo"}\NormalTok{, }\DataTypeTok{from=}\StringTok{"2018{-}06{-}01"}\NormalTok{, }\DataTypeTok{to=}\StringTok{"2020{-}06{-}02"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow  =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
  \KeywordTok{chartSeries}\NormalTok{(TEF.MC)}
  \KeywordTok{chartSeries}\NormalTok{(UNA.AS)}
  \KeywordTok{chartSeries}\NormalTok{(GLE.PA)}
  \KeywordTok{chartSeries}\NormalTok{(AIR.PA)}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.4\linewidth]{bookdown-demo_files/figure-latex/cotacao-1} \includegraphics[width=0.4\linewidth]{bookdown-demo_files/figure-latex/cotacao-2} \includegraphics[width=0.4\linewidth]{bookdown-demo_files/figure-latex/cotacao-3} \includegraphics[width=0.4\linewidth]{bookdown-demo_files/figure-latex/cotacao-4} 

}

\caption{Evolução da cotação nos últimos 2 anos}\label{fig:cotacao}
\end{figure}
\normalsize
\FloatBarrier
\centering
...
## mu     -0.000009    0.000683 -0.012546  0.98999
## omega   0.000006    0.000005  1.127051  0.25972
## alpha1  0.131187    0.021268  6.168232  0.00000
## beta1   0.867813    0.024966 34.760017  0.00000
## 
## Robust Standard Errors:
##         Estimate  Std. Error  t value Pr(>|t|)
## mu     -0.000009    0.000795 -0.01079 0.991391
## omega   0.000006    0.000020  0.29634 0.766968
## alpha1  0.131187    0.047271  2.77524 0.005516
## beta1   0.867813    0.094008  9.23122 0.000000
## 
## LogLikelihood : 1277.896 
## 
...
##                         statistic p-value
## Lag[1]                      6.528 0.01062
## Lag[2*(p+q)+(p+q)-1][2]     6.575 0.01547
## Lag[4*(p+q)+(p+q)-1][5]     8.503 0.02207
## d.o.f=0
...
## ------------------------------------
##                         statistic p-value
## Lag[1]                    0.02608  0.8717
## Lag[2*(p+q)+(p+q)-1][5]   0.39239  0.9730
## Lag[4*(p+q)+(p+q)-1][9]   2.42605  0.8485
## d.o.f=2
## 
## Weighted ARCH LM Tests
## ------------------------------------
##             Statistic Shape Scale P-Value
## ARCH Lag[3]   0.05388 0.500 2.000  0.8164
## ARCH Lag[5]   0.72455 1.440 1.667  0.8160
## ARCH Lag[7]   3.01402 2.315 1.543  0.5109
## 
## Nyblom stability test
## ------------------------------------
## Joint Statistic:  1.2194
...
## ------------------------------------
##                    t-value   prob sig
## Sign Bias           0.9045 0.3662    
## Negative Sign Bias  0.2516 0.8015    
## Positive Sign Bias  0.3778 0.7057    
## Joint Effect        0.8416 0.8395    
## 
## 
...
## ------------------------------------
##         Estimate  Std. Error  t value Pr(>|t|)
## mu      -0.00028    0.000718 -0.38937 0.697004
## omega    0.00001    0.000007  1.43216 0.152098
## alpha1   0.14945    0.037597  3.97498 0.000070
## beta1    0.84955    0.034397 24.69842 0.000000
## skew     1.00637    0.059294 16.97256 0.000000
## shape    4.58152    0.976792  4.69037 0.000003
## 
## Robust Standard Errors:
##         Estimate  Std. Error  t value Pr(>|t|)
## mu      -0.00028    0.000828 -0.33741 0.735811
## omega    0.00001    0.000010  1.03543 0.300467
## alpha1   0.14945    0.050660  2.94995 0.003178
## beta1    0.84955    0.040648 20.90043 0.000000
## skew     1.00637    0.048778 20.63142 0.000000
## shape    4.58152    1.315381  3.48304 0.000496
## 
## LogLikelihood : 1308.308 
## 
## Information Criteria
## ------------------------------------
##                     
...
##                         statistic p-value
## Lag[1]                      6.108 0.01346
## Lag[2*(p+q)+(p+q)-1][2]     6.150 0.02006
## Lag[4*(p+q)+(p+q)-1][5]     7.936 0.03057
## d.o.f=0
## H0 : No serial correlation
## 
## Weighted Ljung-Box Test on Standardized Squared Residuals
## ------------------------------------
##                         statistic p-value
## Lag[1]                    0.03767  0.8461
## Lag[2*(p+q)+(p+q)-1][5]   0.35938  0.9771
## Lag[4*(p+q)+(p+q)-1][9]   2.61582  0.8203
## d.o.f=2
## 
## Weighted ARCH LM Tests
## ------------------------------------
##             Statistic Shape Scale P-Value
## ARCH Lag[3]   0.06827 0.500 2.000  0.7939
## ARCH Lag[5]   0.61425 1.440 1.667  0.8494
## ARCH Lag[7]   3.23445 2.315 1.543  0.4704
## 
## Nyblom stability test
## ------------------------------------
## Joint Statistic:  2.6829
## Individual Statistics:              
## mu     0.13510
## omega  0.36284
## alpha1 0.10539
...
## ------------------------------------
##                    t-value   prob sig
## Sign Bias           0.8638 0.3881    
## Negative Sign Bias  0.2443 0.8071    
## Positive Sign Bias  0.3225 0.7472    
## Joint Effect        0.7666 0.8574    
## 
## 
## Adjusted Pearson Goodness-of-Fit Test:
## ------------------------------------
...
## ------------------------------------
##         Estimate  Std. Error  t value Pr(>|t|)
## mu     -0.000455    0.000632 -0.71985 0.471618
## omega   0.000010    0.000010  1.00731 0.313786
## alpha1  0.052271    0.047765  1.09434 0.273804
## beta1   0.866206    0.020314 42.64006 0.000000
## gamma1  0.160828    0.050032  3.21449 0.001307
## skew    1.002864    0.058111 17.25763 0.000000
## shape   4.341634    0.525640  8.25971 0.000000
## 
## Robust Standard Errors:
##         Estimate  Std. Error  t value Pr(>|t|)
## mu     -0.000455    0.001203 -0.37810 0.705357
## omega   0.000010    0.000027  0.39059 0.696103
## alpha1  0.052271    0.144235  0.36240 0.717052
## beta1   0.866206    0.054682 15.84071 0.000000
## gamma1  0.160828    0.102882  1.56323 0.117998
## skew    1.002864    0.061938 16.19138 0.000000
## shape   4.341634    1.668031  2.60285 0.009245
## 
## LogLikelihood : 1311.898 
## 
## Information Criteria
## ------------------------------------
##                     
...
##                         statistic p-value
## Lag[1]                      6.131 0.01328
## Lag[2*(p+q)+(p+q)-1][2]     6.134 0.02026
## Lag[4*(p+q)+(p+q)-1][5]     7.593 0.03715
## d.o.f=0
## H0 : No serial correlation
## 
## Weighted Ljung-Box Test on Standardized Squared Residuals
## ------------------------------------
##                         statistic p-value
## Lag[1]                  0.0001617  0.9899
## Lag[2*(p+q)+(p+q)-1][5] 0.3918931  0.9730
## Lag[4*(p+q)+(p+q)-1][9] 1.5681695  0.9498
## d.o.f=2
## 
## Weighted ARCH LM Tests
## ------------------------------------
##             Statistic Shape Scale P-Value
## ARCH Lag[3]    0.1559 0.500 2.000  0.6929
## ARCH Lag[5]    0.6961 1.440 1.667  0.8247
## ARCH Lag[7]    1.9495 2.315 1.543  0.7280
## 
## Nyblom stability test
## ------------------------------------
## Joint Statistic:  4.2582
## Individual Statistics:              
## mu     0.20158
## omega  0.43385
## alpha1 0.08691
...
## ------------------------------------
##                    t-value   prob sig
## Sign Bias          0.84322 0.3995    
## Negative Sign Bias 0.20425 0.8382    
## Positive Sign Bias 0.06488 0.9483    
## Joint Effect       1.26462 0.7376    
## 
## 
## Adjusted Pearson Goodness-of-Fit Test:
## ------------------------------------
...
## ------------------------------------
##         Estimate  Std. Error  t value Pr(>|t|)
## mu     -0.000209    0.000850 -0.24583 0.805811
## archm  -0.260052    1.687089 -0.15414 0.877498
## omega   0.000010    0.000007  1.43333 0.151763
## alpha1  0.149581    0.037547  3.98389 0.000068
## beta1   0.849419    0.034397 24.69457 0.000000
## skew    1.005659    0.059422 16.92389 0.000000
## shape   4.588790    0.980615  4.67950 0.000003
## 
## Robust Standard Errors:
##         Estimate  Std. Error  t value Pr(>|t|)
## mu     -0.000209    0.000908 -0.23029 0.817870
## archm  -0.260052    1.227161 -0.21191 0.832175
## omega   0.000010    0.000010  1.03683 0.299815
## alpha1  0.149581    0.050737  2.94820 0.003196
## beta1   0.849419    0.040798 20.82014 0.000000
## skew    1.005659    0.049280 20.40702 0.000000
## shape   4.588790    1.331994  3.44505 0.000571
## 
## LogLikelihood : 1308.32 
## 
## Information Criteria
## ------------------------------------
##                     
...
##                         statistic p-value
## Lag[1]                      6.104 0.01349
## Lag[2*(p+q)+(p+q)-1][2]     6.148 0.02009
## Lag[4*(p+q)+(p+q)-1][5]     7.929 0.03069
## d.o.f=0
## H0 : No serial correlation
## 
## Weighted Ljung-Box Test on Standardized Squared Residuals
## ------------------------------------
##                         statistic p-value
## Lag[1]                    0.03392  0.8539
## Lag[2*(p+q)+(p+q)-1][5]   0.35242  0.9779
## Lag[4*(p+q)+(p+q)-1][9]   2.65713  0.8139
## d.o.f=2
## 
## Weighted ARCH LM Tests
## ------------------------------------
##             Statistic Shape Scale P-Value
## ARCH Lag[3]    0.0789 0.500 2.000  0.7788
## ARCH Lag[5]    0.6025 1.440 1.667  0.8530
## ARCH Lag[7]    3.2903 2.315 1.543  0.4605
## 
## Nyblom stability test
## ------------------------------------
## Joint Statistic:  2.6894
## Individual Statistics:              
## mu     0.13939
## archm  0.06144
## omega  0.36140
...
## ------------------------------------
##                    t-value   prob sig
## Sign Bias           0.8306 0.4066    
## Negative Sign Bias  0.2560 0.7981    
## Positive Sign Bias  0.2967 0.7668    
## Joint Effect        0.7041 0.8722    
## 
## 
## Adjusted Pearson Goodness-of-Fit Test:
## ------------------------------------
