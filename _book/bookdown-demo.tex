...
Antes de entrar no tema relativo a volatilidade, vamos introduzir o tema relativo ao modelo auto-regressivo de médias móveis ou ARMA, sendo um modelo que descreve processo estocásticos estacionários, ou seja, processos cujo parâmetros como a média e a variância não mudam ao longo do tempo, combinando dois factores, um relativo à autorregressão (AR) e outro relativo à média móvel (MA), permitindo desta forma que o número de parâmetros seja pequeno e alcançando parcimônia na parametrização (\citet{parcimonia}).
...
\end{equation}
onde \(\varepsilon\) representa \emph{white noise} e o \(\phi\) o coeficiente de autorregressão.
...
{\centering \includegraphics[width=0.45\linewidth]{bookdown-demo_files/figure-latex/frontewma-1} 
...
## <environment: 0x0000000022f37e50>
...
## 
## Description:
##  Sat Feb 06 21:49:43 2021 by user: lsbap 
## 
## 
...
{\centering \includegraphics[width=0.45\linewidth]{bookdown-demo_files/figure-latex/frontgarch-1} 
...
{\centering \includegraphics[width=0.45\linewidth]{bookdown-demo_files/figure-latex/frontVI-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SimReturnsR \textless{}{-}}\StringTok{ }\KeywordTok{as.timeSeries}\NormalTok{(myPortfolioReturnsR)}
\CommentTok{\#returns the portfolio with the minimal risk on the efficient frontier}
\NormalTok{equalweights \textless{}{-}}\StringTok{ }\KeywordTok{Return.portfolio}\NormalTok{(SimReturnsR,}\DataTypeTok{weights =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{)) }
\KeywordTok{stdev}\NormalTok{(equalweights}\OperatorTok{$}\NormalTok{portfolio.returns)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{optweightsR \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{)}
\NormalTok{ModVaR\_}\DecValTok{95}\NormalTok{\_R \textless{}{-}}\StringTok{ }\KeywordTok{VaR}\NormalTok{(myPortfolioReturnsR, }\DataTypeTok{p=}\FloatTok{0.95}\NormalTok{,}\DataTypeTok{weights=}\NormalTok{optweightsR, }\DataTypeTok{portfolio\_method =} \StringTok{"component"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"modified"}\NormalTok{)}
\NormalTok{ModVaR\_}\DecValTok{95}\NormalTok{\_R}\OperatorTok{$}\NormalTok{MVaR}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#returns the portfolio with the minimal risk on the efficient frontier}
\NormalTok{equalweightsvi \textless{}{-}}\StringTok{ }\KeywordTok{Return.portfolio}\NormalTok{(SimReturnsRvi,}\DataTypeTok{weights =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.3086148}\NormalTok{, }\FloatTok{0.4442713}\NormalTok{, }\FloatTok{0.1409448}\NormalTok{, }\FloatTok{0.1061691}\NormalTok{)) }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{optweightsvi \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.3086148}\NormalTok{, }\FloatTok{0.4442713}\NormalTok{, }\FloatTok{0.1409448}\NormalTok{, }\FloatTok{0.1061691}\NormalTok{)}
...
\CommentTok{\#returns the portfolio with the minimal risk on the efficient frontier}
\NormalTok{equalweightsgarch \textless{}{-}}\StringTok{ }\KeywordTok{Return.portfolio}\NormalTok{(SimReturnsRgarch,}\DataTypeTok{weights =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.2440413}\NormalTok{, }\FloatTok{0.5635348}\NormalTok{, }\FloatTok{0.0229443}\NormalTok{, }\FloatTok{0.1694796}\NormalTok{)) }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{optweightsgarch \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.2440413}\NormalTok{, }\FloatTok{0.5635348}\NormalTok{, }\FloatTok{0.0229443}\NormalTok{, }\FloatTok{0.1694796}\NormalTok{)}
...
\CommentTok{\#returns the portfolio with the minimal risk on the efficient frontier}
\NormalTok{equalweightsewma \textless{}{-}}\StringTok{ }\KeywordTok{Return.portfolio}\NormalTok{(SimReturnsRewma,}\DataTypeTok{weights =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.2939002}\NormalTok{, }\FloatTok{0.6052965}\NormalTok{, }\FloatTok{0.0698046}\NormalTok{, }\FloatTok{0.0309987}\NormalTok{)) }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{optweightsewma \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.2939002}\NormalTok{, }\FloatTok{0.6052965}\NormalTok{, }\FloatTok{0.0698046}\NormalTok{, }\FloatTok{0.0309987}\NormalTok{)}
...
\NormalTok{minvarRR}\OperatorTok{@}\NormalTok{portfolio}
\end{Highlighting}
\end{Shaded}
