...
SimReturnsRewma <- as.timeSeries(myPortfolioReturnsR)
equalweightsewma <- Return.portfolio(SimReturnsRewma,weights = c(0.3452717,0.5028658, 0, 0.1518625)) 
stdev(equalweightsewma$portfolio.returns)
```

```{r}
histstd <- c(0.3452717,0.5028658, 0, 0.1518625)
ModVaR_95_ewma <- VaR(myPortfolioReturnsR, p=0.95,weights=histstd , portfolio_method = "component", method = "modified")
ModVaR_95_ewma$MVaR
```
