...
```{r,grafico,echo=FALSE,fig.cap='Evolução dos portfolios ao longo dos 80 dias',out.width="80%"}
...
```{r,retggplot,echo=FALSE, fig.cap='Retornos dos portfólios - 80 dias',fig.topcaption = TRUE,out.width = "80%"}
