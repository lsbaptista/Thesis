...
```{r,fecho, echo=FALSE}
newdata <- merge(TEF.MC$Close,ENEL.MI$Close,GLE.PA$Close,AIR.PA$Close)
...
```{r,teste,echo=FALSE, fig.cap='Teste a normalidade das distribuições',fig.topcaption = TRUE,out.width = "80%"}
par(mfrow  = c(2,2))
