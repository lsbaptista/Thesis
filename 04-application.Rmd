...
```{r,frontewma,echo=FALSE, fig.cap='EWMA - Fronteira eficiente',fig.topcaption = TRUE,out.width = "100%"}
...
\scriptsize
```{r}
garchweights <- c(0.2440413, 0.5635348, 0.0229443, 0.1694796)
...
\scriptsize
```{r}
viweights <- c(0.3086148, 0.4442713, 0.1409448, 0.1061691)
