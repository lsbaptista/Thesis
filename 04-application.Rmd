...
```{r,frontewma,echo=FALSE, fig.cap='EWMA - Fronteira eficiente',fig.topcaption = TRUE,out.width = "45%"}
...
```{r,echo=FALSE,warning = FALSE}
TEF<-garchFit(formula = ~ garch(1,1),data=returns$TEF.RET,cond.dist = "norm", trace=FALSE)
...
```{r,frontgarch,echo=FALSE, fig.cap='GARCH - Fronteira eficiente',fig.topcaption = TRUE,out.width = "45%"}
...
\scriptsize
```{r}
optweights <- c(0.2440413, 0.5635348, 0.0229443, 0.1694796)
...
```{r,frontVI,echo=FALSE, fig.cap='Volatilidade Implícita - Fronteira eficiente',fig.topcaption = TRUE,out.width = "45%"}
