...
```{r,include=FALSE}
rm(list = ls())
knitr::opts_chunk$set(tidy=TRUE, tidy.opts=list(width.cutoff=50),encoding = 'UTF-8',force_v1 = TRUE)
...
stocks <- getSymbols(symbolsEU,src="yahoo", from="2012-06-18", to="2020-06-02",auto.assign = TRUE)
