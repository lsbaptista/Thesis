...
\end{equation}
onde $\varepsilon$ representa *white noise* e o $\phi$ o coeficiente de autorregressão. Ou seja, esta equação diz-nos que os valores presentes da variável dependem do seu valor passado.
