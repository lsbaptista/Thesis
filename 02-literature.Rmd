...
\end{equation}
onde $\varepsilon$ representa *white noise* e o $\phi$ o coeficiente de autorregressão.
...
De acordo com @marta este modelo é expresso pela equação onde a variância condicionada, $\sigma_t^2$ é uma função assimétrica dos valores passados de $\mu_t$, ou seja:
\begin{equation} 
